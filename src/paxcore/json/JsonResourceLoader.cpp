...
namespace PAX {
    ...
    std::shared_ptr<nlohmann::json> JsonResourceLoader::loadToOrGetFromResources(Resources &resources, const VariableHierarchy &parameters) {
        loadFromPath("JsonResourceLoader", resources, parameters);
    }
}