...
namespace PAX {
    ...
    public:
        EntityComponentRemovedEvent(const std::shared_ptr<EntityComponentType> & component, Entity *entity) : EntityComponentEvent<EntityComponentType>(component, entity) {}
    };
}
